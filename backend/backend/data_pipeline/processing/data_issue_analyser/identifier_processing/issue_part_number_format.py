...
class PartNumberFormatIssueAnalyzer:
    """
    Analyzer for identifying and analyzing issue part number format issues in datasets.
    """

    def __init__(self, confidence_threshold: float = 0.8):
        self.name = "issue_part_number_format"
