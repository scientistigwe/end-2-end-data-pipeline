...
class PatientIdMismatchIssueAnalyzer:
    """
    Analyzer for identifying and analyzing issue patient id mismatch issues in datasets.
    """

    def __init__(self, confidence_threshold: float = 0.8):
        self.name = "issue_patient_id_mismatch"
