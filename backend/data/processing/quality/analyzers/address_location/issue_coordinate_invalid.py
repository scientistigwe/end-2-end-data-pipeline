...
class CoordinateInvalidIssueAnalyzer:
    """
    Analyzer for identifying and analyzing issue coordinate invalid issues in datasets.
    """

    def __init__(self, confidence_threshold: float = 0.8):
        self.name = "issue_coordinate_invalid"
