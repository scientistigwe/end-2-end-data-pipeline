...
export class AuthApiClient {
  ...
  private async request<T>(
      ...
      try {
          const requestConfig: AxiosRequestConfig = {
              ...
              data,
              ...axiosConfig,
              onUploadProgress: axiosConfig?.onUploadProgress as ((progressEvent: AxiosProgressEvent) => void) | undefined
          };
  ...
  public async logout(): Promise<ApiResponse<void>> {
      const result = await this.request<void>('post', API_CONFIG.ENDPOINTS.AUTH.LOGOUT);
      this.clearTokens();
      return result;
  }
  ...
  public async changePassword(data: ChangePasswordData): Promise<ApiResponse<void>> {
      return this.request<void>('post', API_CONFIG.ENDPOINTS.AUTH.CHANGE_PASSWORD, {}, data);
  }

  public async verifyEmail(data: VerifyEmailData): Promise<ApiResponse<void>> {
      return this.request<void>('post', API_CONFIG.ENDPOINTS.AUTH.VERIFY_EMAIL, {}, data);
  }

  public async forgotPassword(email: string): Promise<ApiResponse<void>> {
      return this.request<void>('post', API_CONFIG.ENDPOINTS.AUTH.FORGOT_PASSWORD, {}, { email });
  }

  public async resetPassword(data: ResetPasswordData): Promise<ApiResponse<void>> {
      return this.request<void>('post', API_CONFIG.ENDPOINTS.AUTH.RESET_PASSWORD, {}, data);
  }
}
