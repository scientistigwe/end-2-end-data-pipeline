...
interface DataSourceContextValue {
  ...
  updateDataSource: (id: string, updates: Partial<DataSourceConfig>) => Promise<void>;
  deleteDataSource: (id: string) => Promise<void>;
  validateDataSource: (id: string) => Promise<void>;
  previewDataSource: (id: string, options?: { limit?: number; offset?: number }) => Promise<void>;
  setFilters: (filters: DataSourceFilters) => void;
  selectDataSource: (source: DataSourceConfig | null) => void;
  clearError: () => void;
}

export const DataSourceContext = createContext<DataSourceContextValue | undefined>(undefined);
