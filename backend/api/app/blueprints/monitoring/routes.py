...
def create_monitoring_blueprint(monitoring_service: MonitoringService, db_session):
    """Create monitoring blueprint with all routes.
    
    Args:
        monitoring_service: Instance of MonitoringService
        db_session: Database session
        
    Returns:
        Blueprint: Configured monitoring blueprint
    """
