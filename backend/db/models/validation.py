# backend\backend\db\types\validation.py
...
class QualityCheck(BaseModel):
    ...
    quality_profile_checks = relationship(
        ...
        back_populates='quality_check',
        cascade='all, delete-orphan',
        overlaps="profiles,quality_checks"
    )
    ...
    profiles = relationship(
        ...
        back_populates='quality_checks',
        overlaps="quality_profile_checks",
        viewonly=True
    )
...
class ValidationResult(BaseModel):
    ...
    decision = relationship('Decision', back_populates='validation_result', uselist=False, cascade='all, delete-orphan')
...
class QualityProfileChecks(BaseModel):
    ...
    quality_profile = relationship(
        'QualityProfile',
        back_populates='quality_profile_checks',
        overlaps="quality_checks,profiles"
    )
