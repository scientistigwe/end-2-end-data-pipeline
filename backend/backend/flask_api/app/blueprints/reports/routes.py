...
def create_reports_blueprint(report_service: ReportService, db_session):
    """Create reports blueprint with all routes.
    
    Args:
        report_service: Instance of ReportService
        db_session: Database session
        
    Returns:
        Blueprint: Configured reports blueprint
    """
