...
@patch("backend.backend.data_pipeline.source.file.file_fetcher.FileFetcher.fetch_file")
@patch("backend.backend.data_pipeline.source.file.file_validator.FileValidator.validate_file_path")
...
@patch("backend.backend.data_pipeline.source.file.file_fetcher.FileFetcher.fetch_file")
@patch("backend.backend.data_pipeline.source.file.file_manager.FileManager.prepare_for_orchestrator")
def test_file_system_error_handling(mock_prepare_for_orchestrator, mock_fetch_file, mock_flask_app):
