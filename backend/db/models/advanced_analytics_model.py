# backend\backend\db\types\advanced_analytics_model.py
...
class AnalyticsRun(BaseModel):
    """Model for advanced_analytics analytics processing runs."""
    ...
    source_id = Column(
        ...
        nullable=True  # Make it optional if not all runs are tied to a source
    )
    
    source = relationship(
        'DataSource',
        back_populates='analytics_runs',
        foreign_keys=[source_id]
    )

    # Optional: Add relationship to insights if applicable
...
class AnalyticsModel(BaseModel):
    """Model for storing trained types and their metrics."""
    ...
    # Relationships
    run = relationship('AnalyticsRun', back_populates='types')
