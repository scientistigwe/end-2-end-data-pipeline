...
def create_settings_blueprint(settings_service: SettingsService, db_session):
    """Create settings blueprint with all routes.
    
    Args:
        settings_service: Instance of SettingsService
        db_session: Database session
        
    Returns:
        Blueprint: Configured settings blueprint
    """
