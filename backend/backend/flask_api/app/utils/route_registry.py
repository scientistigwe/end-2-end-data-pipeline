...
class APIRoutes(Enum):
    ...
    DATASOURCE_DB_CONNECT = RouteDefinition('/data-sources/database/connect', ['POST'])
    DATASOURCE_DB_TEST = RouteDefinition('/data-sources/database/{connection_id}/test', ['POST'])
    DATASOURCE_DB_QUERY = RouteDefinition('/data-sources/database/{connection_id}/query', ['POST'])
    DATASOURCE_DB_SCHEMA = RouteDefinition('/data-sources/database/{connection_id}/schema', ['GET'])
    DATASOURCE_DB_METADATA = RouteDefinition('/data-sources/database/metadata', ['GET'])
