...
class InstrumentInvalidIssueAnalyzer:
    """
    Analyzer for identifying and analyzing issue instrument invalid issues in datasets.
    """

    def __init__(self, confidence_threshold: float = 0.8):
        self.name = "issue_instrument_invalid"
