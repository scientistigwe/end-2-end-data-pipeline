...
from backend.src.end_2_end_data_pipeline.data_pipeline.exceptions import CloudQueryError
...
@patch('backend.src.end_2_end_data_pipeline.data_pipeline.source.cloud.s3_data_loader.pd.read_parquet')
