...
class PipelineManager:
    ...
    def __init__(self, message_broker: MessageBroker):
        ...
        self.module_identifier = ModuleIdentifier(
            ...
            component_type=ComponentType.PIPELINE_MANAGER,
            department="pipeline",
            role="manager"
        )
    ...
    async def _handle_data_receive(self, message: ProcessingMessage) -> None:
        ...
        try:
            ...
            logger.error(f"Failed to handle data reception: {str(e)}")
    ...
    # ... Additional handlers for other components ...
    ...
    async def _cleanup_pipeline(self, pipeline_id: str) -> None:
        ...
        try:
            ...
            logger.info(f"Pipeline {pipeline_id} cleaned up successfully")
