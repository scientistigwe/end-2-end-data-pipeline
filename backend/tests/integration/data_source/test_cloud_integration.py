...
from backend.src.end_2_end_data_pipeline.data_pipeline.source.cloud.s3_connector import S3Connector
from backend.src.end_2_end_data_pipeline.data_pipeline.source.cloud.s3_data_loader import S3DataLoader
from backend.src.end_2_end_data_pipeline.data_pipeline.source.cloud.s3_data_manager import S3DataManager
from backend.src.end_2_end_data_pipeline.data_pipeline.source.cloud.s3_security import DataSecurityManager
...
def security_manager():
    with patch('backend.src.end_2_end_data_pipeline.data_pipeline.source.cloud.s3_security.os.environ',
...
@patch('backend.src.end_2_end_data_pipeline.data_pipeline.source.cloud.s3_data_loader.pd.read_csv')
...
@patch('backend.src.end_2_end_data_pipeline.data_pipeline.source.cloud.s3_security.Fernet.encrypt')
@patch('backend.src.end_2_end_data_pipeline.data_pipeline.source.cloud.s3_security.Fernet.decrypt')
